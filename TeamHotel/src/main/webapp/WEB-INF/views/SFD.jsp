...
<body style="text-align:center;">
	<div class="roomTab">
		<ul>
			<li ><a href="/hotel/superior/SDB">Superior Double</a></li>
			<li><a href="/hotel/superior/STW">Superior Twin</a></li>
			<li class="on"><a href="/hotel/superior/SFD">Superior Family Double</a></li>
			<li><a href="/hotel/superior/SFT">Superior Family Twin</a></li>
		</ul>
	</div><div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="margin-top:100px; margin-bottom:45px;">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="https://new.stjohns.co.kr/uploads/room/2020/12/7ebf55cf829ccd8f87a5d5168b5b8ca4.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
       <h5>Superior Family Double</h5>
        <p>Free Wi-Fi / Double size Bed / Hair Dryer / Amenity</p>
      </div>
    ...
    <div class="carousel-item">
      <img src="https://new.stjohns.co.kr/uploads/room/2020/12/9f86a6417a5505ac42a93e666250326a.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
       <h5>Superior Family Double</h5>
        <p>Free Wi-Fi / Double size Bed / Hair Dryer / Amenity</p>
      </div>
